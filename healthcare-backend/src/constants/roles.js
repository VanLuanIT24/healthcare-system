...
const PERMISSIONS = Object.freeze({
  ...
  PATIENT_VIEW: "PATIENT.VIEW", // Xem danh sách bệnh nhân
  PATIENT_CREATE: "PATIENT.CREATE", // Tạo hồ sơ bệnh nhân
  PATIENT_UPDATE: "PATIENT.UPDATE", // Cập nhật hồ sơ bệnh nhân
  PATIENT_ADMIT: "PATIENT.ADMIT", // Nhập viện
  PATIENT_DISCHARGE: "PATIENT.DISCHARGE", // Xuất viện
...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.HOSPITAL_ADMIN]: [
    ...
    PERMISSIONS.LOGIN,
    PERMISSIONS.LOGOUT,
    PERMISSIONS.REGISTER_DEPARTMENT_HEAD,
    PERMISSIONS.REGISTER_DOCTOR,
    PERMISSIONS.REGISTER_NURSE,
    PERMISSIONS.REGISTER_PHARMACIST,
    PERMISSIONS.REGISTER_LAB_TECHNICIAN,
    PERMISSIONS.REGISTER_BILLING_STAFF,
  ...
  [ROLES.DEPARTMENT_HEAD]: [
    ...
    PERMISSIONS.VIEW_SCHEDULE,
    PERMISSIONS.VIEW_LAB_RESULTS,
    PERMISSIONS.APPROVE_LAB_RESULTS,
    PERMISSIONS.VIEW_REPORTS,
    PERMISSIONS.GENERATE_REPORTS,
    PERMISSIONS.EMERGENCY_ACCESS,
  ],
  ...
  [ROLES.DOCTOR]: [
    ...
    PERMISSIONS.VIEW_SCHEDULE,
    PERMISSIONS.VIEW_LAB_RESULTS,
    PERMISSIONS.CREATE_LAB_RESULTS,
    PERMISSIONS.PATIENT_VIEW, // Xem danh sách bệnh nhân
    PERMISSIONS.EMERGENCY_ACCESS,
  ],
...
function canCreateRole(currentRole, targetRole) {
  ...
  if (currentRole === ROLES.DEPARTMENT_HEAD) {
    return [ROLES.DOCTOR, ROLES.NURSE, ROLES.LAB_TECHNICIAN].includes(
      targetRole
    );
  }
...
function hasSystemAccess(role) {
  ...
  return systemPermissions.some((permission) =>
    hasPermission(role, permission)
  );
}
