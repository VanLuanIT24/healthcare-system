...
import {
  Form, Input, Button, Card, Row, Col, Select, Upload, Spin, message, DatePicker, 
  Space, Table, Modal, InputNumber, Tag, Checkbox
} from 'antd';
import { LoadingOutlined, PlusOutlined, DeleteOutlined, ArrowLeftOutlined } from '@ant-design/icons';
        ...
        try {
          ...
          if (res.data?.data) {
            ...
            form.setFieldsValue({
              ...
              specialtyId: docData.specialties?.[0]?._id,
